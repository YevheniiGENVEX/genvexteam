      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Як офіційний партнер служби доставки Amazon (DSP) у Гамбурзі, команда GENVEX поєднує 
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">Офіційний DSP Amazon з повною підтримкою</p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">Конкурентна оплата з премією за результативність</p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                ...
                <div className="flex items-start space-x-3">
                  <CheckCircle className="h-6 w-6 text-blue-600 mt-1 flex-shrink-0" />
                  <p className="text-gray-700">Підтримуюче командне середовище в Гамбурзі</p>
                </div>
              </div>
              <Button 
                onClick={() => scrollToSection('positions')}
