      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Готові розпочати кар'єру з командою GENVEX Team? Зв'яжіться з нами сьогодні. 
            Ми тут, щоб відповісти на ваші запитання та провести вас до успішного старту роботи.
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700">20539 Гамбург, Німеччина</p>
                  </div>
                  
                  <div className="flex items-center space-x-2">
                    <Clock className="h-4 w-4 text-blue-600" />
                    <span className="text-sm text-gray-600">Пн-Сб: 8:00 - 18:00</span>
                  </div>
            ...
            <Card className="bg-blue-50 shadow-lg border-0">
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• Підтвердження заявки до 1 години</li>
                  <li>• Перший контакт — не пізніше ніж через 12 годин після звернення</li>
                  <li>• Повний процес найму зазвичай займає 1-2 тижні (Навчання та практика до самостійного виходу на роботу- оплачується)</li>
